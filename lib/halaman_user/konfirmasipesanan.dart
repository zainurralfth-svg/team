...
class _KonfirmasiPageState extends State<KonfirmasiPage> {
  ...
  bool _isLoadingProfile =
      true; // Status untuk menampilkan animasi loading saat aplikasi mencari data user.
  bool _isProcessing =
      false; // Status untuk mengunci tombol agar pengguna tidak klik berkali-kali (mencegah pesanan dobel).
    ...
    try {
      ...
      if (response['status'] == 'sukses') {
        ...
        Navigator.pushReplacementNamed(
          ...
          arguments: {
            'kode_resi':
                response['kode_resi'], // Kode unik pesanan dari server.
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const Expanded(
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          fontFamily:
                              'Signika Negative', // 👈 Diganti biar normal
                          fontWeight: FontWeight
                              .bold, // 👈 Ditambahin biar tebal & tegas
                          color: AppColors.textWhite,
                          fontSize:
                              24, // 👈 Disesuaikan ukurannya biar sama persis kayak di keranjang
                        ),
                      ),
                    ),
                  ),
                  const SizedBox(
                    width: 26,
                  ), // Ruang kosong untuk menjaga teks judul tetap di tengah.
                ],
              ),
            ),
                  ...
                  : SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                ListView.builder(
                                  shrinkWrap:
                                      true, // Membatasi tinggi daftar barang agar tidak memakan ruang kosong.
                                  physics:
                                      const NeverScrollableScrollPhysics(), // Mematikan scroll bawaan agar bisa di-scroll menyatu dengan halaman.
                          ...
                          const SizedBox(
                            height: 6,
                          ), // Jarak tipis antara label dan kotak input
                          _buildTextField(
                            "Contoh: Muhammad Arief",
                            Icons.person,
                            AppColors.primary,
                            _namaController,
                          ),
                          ...
                          const SizedBox(height: 6),
                          _buildNotesField(
                            "Ketik catatan untuk pesanan kamu di sini...",
                            Icons.edit_note,
                            AppColors.primary,
                            _catatanController,
                          ),
                          ...
                          Center(
                            child: ElevatedButton(
                              ...
                              onPressed: _isProcessing
                                  ? null
                                  : () => _prosesPesanan(cartItems, totalHarga),
  ...
  Widget _buildNotesField(
    ...
    return TextField(
      controller: controller,
      maxLines:
          3, // Mengatur agar kotak menampung maksimal 3 baris tulisan secara vertikal.
      style: const TextStyle(
        fontFamily: 'Signika Negative',
        color: AppColors.textDark,
      ),
